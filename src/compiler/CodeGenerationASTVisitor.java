...
public class CodeGenerationASTVisitor extends BaseASTVisitor<String, VoidException> {
	 ...
	 * Visito le dichiarazioni di variabili, in ordine, concatenandole (attraverso la visita vengono poi  messe sullo stack).
	 * */
	@Override
	 ...
	 * del corpo della funzione, che metterò dopo l'halt. Ovvero ho una collezione di funzioni alla fine, in cui saltare
	...
	/**
	 * 1. Devo caricare sullo stack il control link. E' il puntatore al frame in cui sono adesso (del chiamante).
	 ...
	 * Mi serve duplicare il valore che ho sulla cima dello stack, lo faccio usando il registro temporaneo
	 * stm (store nel tm). Usando due volte ltm ho un valore duplicato sulla cima dello stack.
	 *
	 * 6. Alla seconda copia, applico l'offset per trovare l'indirizzo della funzione e faccio il salto.
	...
	/**
	 * A differenza dalla chiamata a funzione qui recupero il dispatch pointer dalla memoria,
	 ...
	 *
	 * Lo abbiamo aggiunto nella symbol table. Dopodiché, aggiungo all'address, l'offset per recuperare la dichiarazione.
	 *
